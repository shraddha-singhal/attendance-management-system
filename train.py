...
def TakeImages():        
    ...
    if(is_number(Id) and name.isalpha()):
        ...
        harcascadePath = (r"E:\Python\Lib\site-packages\cv2\data\haarcascade_frontalface_default.xml")
        ...
        while(True):
            ...
            for (x,y,w,h) in faces:
                ...
                cv2.imwrite(r"C:\Users\aggar\Desktop\Face-Recognition-Based-Attendance-System-master\TrainingImage\ "+name +"."+Id +'.'+ str(sampleNum) + ".jpg", gray[y:y+h,x:x+w])
                #display the frame
        ...
        row = [Id , name]
        with open(r"C:\Users\aggar\Desktop\Face-Recognition-Based-Attendance-System-master\StudentDetails.csv","a+") as csvFile:
...
def TrainImages():
    ...
    harcascadePath = (r"E:\Python\Lib\site-packages\cv2\data\haarcascade_frontalface_default.xml")
    detector =cv2.CascadeClassifier(harcascadePath)
    faces,Id = getImagesAndLabels(r"C:\Users\aggar\Desktop\Face-Recognition-Based-Attendance-System-master\TrainingImage")
    recognizer.train(faces, np.array(Id))
    recognizer.save(r"C:\Users\aggar\Desktop\Face-Recognition-Based-Attendance-System-master\Trainner.yml")
...
def TrackImages():
    ...
    recognizer.read(r"C:\Users\aggar\Desktop\Face-Recognition-Based-Attendance-System-master\Trainner.yml")
    harcascadePath = (r"E:\Python\Lib\site-packages\cv2\data\haarcascade_frontalface_default.xml")
    faceCascade = cv2.CascadeClassifier(harcascadePath);    
    df=pd.read_csv(r"C:\Users\aggar\Desktop\Face-Recognition-Based-Attendance-System-master\StudentDetails.csv")
    cam = cv2.VideoCapture(0)
    ...
    while True:
        ...
        for(x,y,w,h) in faces:
            ...
            if(conf < 50):
                ...
                tt=str(Id)  
            if(conf > 75):
                noOfFile=len(os.listdir(r"C:\Users\aggar\Desktop\Face-Recognition-Based-Attendance-System-master\ImagesUnknown"))+1
                cv2.imwrite(r"C:\Users\aggar\Desktop\Face-Recognition-Based-Attendance-System-master\ImagesUnknown\Image"+str(noOfFile) + ".jpg", im[y:y+h,x:x+w])            
    ...
    fileName=(r"C:\Users\aggar\Desktop\Face-Recognition-Based-Attendance-System-master\Attendance_"+date+"_"+Hour+"-"+Minute+"-"+Second+".csv")
